...
const StateCard = () => {
    ...
    return (
        <div>
            <h1 className={`text-3xl font-bold text-center ${theme === "dark" ? "text-yellow-500" : "text-blue-600"}`}>Weather</h1>
            <div className={`max-w-md p-8 mx-auto rounded-lg ${theme === "dark" ? "text-gray-100 bg-gray-900" : "dark:bg-gray-50 dark:text-gray-800"}`}>
                <div className="flex justify-between space-x-8">
                    <div className="flex flex-col items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-24 h-24 p-2 text-yellow-600 fill-current">
                ...
                <div className={`flex justify-between mt-8 space-x-4 ${theme === "dark" ? "text-gray-50" : "text-gray-600"}`}>
